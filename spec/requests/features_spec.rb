...
RSpec.feature 'Integrations', type: :feature do
  before :each do
    ...
    user2 = User.create!(name: 'Bar', email: 'bar@example.org', password: '123456', password_confirmation: '123456')
    user3 = User.create!(name: 'Jam', email: 'jam@example.org', password: '123456', password_confirmation: '123456')
    friendship = Friendship.create!(user_id: user2.id, friend_id: user.id, confirmed: false)
